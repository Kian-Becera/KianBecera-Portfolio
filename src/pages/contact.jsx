...
export default function Contact() {
  ...
  return (
    <Layout toast={toast} title="Contact — KIAN BECERA">
      ...
      {/* ════ BODY — single column, all cards equal width ════ */}
      <section className="py-20 overflow-x-hidden">
        <div className="max-w-3xl mx-auto px-6 flex flex-col gap-5">
          ...
          <div className="dark:bg-dark-card bg-white
                          ...
                          rounded-2xl p-6 shadow-sm animate-fade-up">
          ...
          <div className="dark:bg-dark-card bg-white
                          border dark:border-dark-border border-slate-200
                          rounded-2xl p-6 shadow-sm animate-fade-up [animation-delay:.06s]">
            <h2 className="font-mono text-xs text-accent tracking-widest uppercase mb-4">
              // direct_channels
            </h2>
              ...
              {CHANNELS.map((ch) => (
                <a key={ch.label} href={ch.href} target="_blank" rel="noreferrer"
                  className="flex items-center gap-3 p-3
                             ...
                             border dark:border-dark-border border-slate-200
                             rounded-xl hover:border-accent group transition-all">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm dark:text-slate-300 text-slate-700
                                  font-medium group-hover:text-accent transition-colors truncate">
                      {ch.value}
                    </p>
                  </div>
          ...
          {/* ── 3. // initiate_inquiry — full form ── */}
          <div className="dark:bg-dark-card bg-white
                          border dark:border-dark-border border-slate-200
                          rounded-2xl p-6 shadow-sm animate-fade-up [animation-delay:.12s]">
            ...
            {Object.keys(errors).length > 0 && (
              <div className="dark:bg-red-900/20 bg-red-50
                              ...
                              rounded-xl p-4 mb-5 text-sm text-red-400">
          ...
          <div className="dark:bg-dark-card bg-white
                          ...
                          animate-fade-up [animation-delay:.18s]">
            <div className="h-48 relative flex items-center justify-center
                            overflow-hidden bg-no-repeat bg-cover"
              style={{ backgroundImage: "url('/images/locations/bacolod2.png')" }}>
